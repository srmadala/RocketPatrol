class Play extends Phaser.Scene {
    ...
    create() {
        ...
        this.time.delayedCall(5000, () => {this.ship01.moveSpeed=(this.ship01.moveSpeed*2)}, null, this); // delay in ms
        this.time.delayedCall(5000, () => {this.ship02.moveSpeed=(this.ship02.moveSpeed*2)}, null, this);  
        this.time.delayedCall(5000, () => {this.ship03.moveSpeed=(this.ship03.moveSpeed*2)}, null, this);  
        ...
        // }, null, this);
        this.tm = 0;
        let myclock = setInterval((this.tm += 1), 1000);
    }
